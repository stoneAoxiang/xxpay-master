...
public class QRCodeController {
    ...
    public String getQRCode(@ApiParam(value = "身份标识", required = true) String clientId,
        ...
        System.out.println(timeStr + " 身份标识:" + clientId);
        System.out.println(timeStr + " 机器编号:" + assetId);
        System.out.println(timeStr + " 商品名称:" + goodsName);
        System.out.println(timeStr + " 商品价格:" + price);
        System.out.println(timeStr + " 商品编码:" + productNum);
        System.out.println(timeStr + " 支付成功回调地址:" + notify_url);
        System.out.println(timeStr + " 订单编号:" + orderNo);
        System.out.println(timeStr + " 随机数:" + nonce_str);
        System.out.println(timeStr + " 签名:" + sign);

        QRCodeWriter qrCodeWriter = new QRCodeWriter();
        String qrContent = "http://113.207.110.34:8081/goods/qrPay.html?assetId=" + assetId + "&goodsName=" + goodsName + "&productNum="
                + productNum + "&price=2&orderNo=" + orderNo + "&notify_url=" + notify_url;
        _log.info("-二维码地址:{}", qrContent);
        return "{\"result\":\"SUCCESS\",  \"qr_code\":\"" + qrContent + "\"}";
