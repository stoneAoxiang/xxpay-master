...
public class PayChannel4WxServiceImpl extends BaseService implements IPayChannel4WxService {
    ...
    public Map doWxPayReq(String jsonParam) {
        String logPrefix = "【微信支付统一下单】-> doWxPayReq";
        _log.info("{}", logPrefix);
        ...
        try{
            ...
            _log.info("{}支付订单信息:{}", logPrefix, payOrder.toString());
            ...
            _log.info("{}支付渠道信息:{}", logPrefix, payChannel.getParam());
            ...
            _log.info("{}获取签名:{}", logPrefix, wxPayUnifiedOrderRequest.getSign());
