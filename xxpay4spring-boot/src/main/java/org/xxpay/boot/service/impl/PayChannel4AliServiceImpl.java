...
public class PayChannel4AliServiceImpl extends BaseService implements IPayChannel4AliService {
    ...
    public Map doAliPayWapReq(String jsonParam) {
        ...
        _log.info("{} 要处理的JSON串{}", logPrefix, jsonParam);
        ...
        _log.info("{} url={} app_id={}", logPrefix, alipayConfig.getUrl(), alipayConfig.getApp_id());
...
//        _log.info("设置异步通知地址url={}", alipayConfig.getNotify_url());
        // 设置同步地址
        alipay_request.setReturnUrl(alipayConfig.getReturn_url());
//        _log.info("设置同步地址url={}", alipayConfig.getReturn_url());
        String payUrl = null;
        try {
